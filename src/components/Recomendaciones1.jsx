...
const Recomendaciones1 = () => {
  return (
    ...
    >
      ...
      Milagros es una persona muy comprometida y trabajadora, siempre dispuesta y con muy buena adaptación a la escucha y los cambios, se comunicó muy bien con el equipo y siempre tuvo sus asignaciones a tiempo. fue muy gratificante trabajar con ella, estoy segura que tiene muy buen futuro en el desarrollo visual, ya que está atenta a los detalles.
      </Typography>
